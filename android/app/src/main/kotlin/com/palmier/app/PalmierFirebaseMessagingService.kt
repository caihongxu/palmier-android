...
class PalmierFirebaseMessagingService : FirebaseMessagingService() {
    ...
    override fun onNewToken(token: String) {
        ...
        // Background refreshes can fire while the PWA isn't running, so register
        // directly here instead of relying on the PWA to read and post the token.
    ...
    override fun onMessageReceived(remoteMessage: RemoteMessage) {
        ...
        when (type) {
            ...
            "send-alarm" -> AlarmHandler.handleSendAlarm(this, data)
            "send-email" -> EmailHandler.handleSendEmail(this, data)
